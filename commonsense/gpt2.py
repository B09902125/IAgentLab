...
def commomsense_test(relation_filename, test_filename, model_name, relation_type):
    ...
    example1_object_2 = 'a baker'
    example2_object_1 = 'A report'
    example2_object_2 = 'a student'
    example3_object_1 = 'A song'
    example3_object_2 = 'a musician'
...
def main():
    ...
    commomsense_test('relation.csv', 'Desires_zero_shot.csv', 'gpt2', relation_type)
    return 
